...
import zhCNAgentGroup from './locales/zh-CN/features/agent-group.json';
...
import enUSAgentGroup from './locales/en-US/features/agent-group.json';
...
import ruRUAgentGroup from './locales/ru-RU/features/agent-group.json';
